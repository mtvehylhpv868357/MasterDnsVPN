...
const (
	...
	PacketPing                            = 0x07
	PacketPong                            = 0x08
	PacketStreamSyn                       = 0x09
	PacketStreamSynAck                    = 0x0A
	PacketStreamData                      = 0x0B
	PacketStreamDataAck                   = 0x0C
	PacketStreamResend                    = 0x0D
	PacketPackedControlBlocks             = 0x0E
	PacketStreamFin                       = 0x0F
	PacketStreamFinAck                    = 0x10
	PacketStreamRST                       = 0x11
	PacketStreamRSTAck                    = 0x12
	PacketStreamKeepalive                 = 0x13
	PacketStreamKeepaliveAck              = 0x14
	PacketStreamWindowUpdate              = 0x15
	PacketStreamWindowUpdateAck           = 0x16
	PacketStreamProbe                     = 0x17
	PacketStreamProbeAck                  = 0x18
	PacketSocks5Syn                       = 0x19
	PacketSocks5SynAck                    = 0x1A
	PacketSocks5ConnectFail               = 0x1B
	PacketSocks5ConnectFailAck            = 0x1C
	PacketSocks5RulesetDenied             = 0x1D
	PacketSocks5RulesetDeniedAck          = 0x1E
	PacketSocks5NetworkUnreachable        = 0x1F
	PacketSocks5NetworkUnreachableAck     = 0x20
	PacketSocks5HostUnreachable           = 0x21
	PacketSocks5HostUnreachableAck        = 0x22
	PacketSocks5ConnectionRefused         = 0x23
	PacketSocks5ConnectionRefusedAck      = 0x24
	PacketSocks5TTLExpired                = 0x25
	PacketSocks5TTLExpiredAck             = 0x26
	PacketSocks5CommandUnsupported        = 0x27
	PacketSocks5CommandUnsupportedAck     = 0x28
	PacketSocks5AddressTypeUnsupported    = 0x29
	PacketSocks5AddressTypeUnsupportedAck = 0x2A
	PacketSocks5AuthFailed                = 0x2B
	PacketSocks5AuthFailedAck             = 0x2C
	PacketSocks5UpstreamUnavailable       = 0x2D
	PacketSocks5UpstreamUnavailableAck    = 0x2E
	PacketDNSQueryReq                     = 0x2F
	PacketDNSQueryRes                     = 0x30
